...
**Acquisition status in this release:** archive routes identified; research metadata collected; existing MCD installation used by the atmospheric app. The new geological, magnetic, radar and seismic datasets in this manifest have not yet been downloaded and harmonized for a joint analysis.
