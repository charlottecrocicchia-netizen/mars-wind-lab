...
PAGES={'RECORDING':'Primary & secondary remanence','WATER':'Water & alteration','FIRST_RESULTS':'Completed diagnostics','HYPOTHESES':'Working hypothesis','TEST_PROTOCOL':'First physical test','SYNTHESIS':'Scientific synthesis','METEORITES':'Meteorite magnetism','MISSIONS':'Missions & data','RESEARCH_PLAN':'Research programme','METHOD':'Search & reading method','COMMUNITY':'Community leads','README':'About this collection'}
